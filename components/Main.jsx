    ...
    return (
      <div id="main" style={this.props.timeout ? { display: 'flex' } : { display: 'none' }}>
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <span className="image main"><img src="/static/images/code.jpg" alt="" /></span>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <span className="main"><img src="/static/images/cider.gif" style={{ margin: 'auto', marginBottom: 'calc(30px - 1em)', marginLeft: 'calc(50% - 50px)', borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }} alt="" /></span>
